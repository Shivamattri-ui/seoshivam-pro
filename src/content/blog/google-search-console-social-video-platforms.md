---
title: "Search Console Now Tracks Your Instagram, TikTok, X, and YouTube"
description: "Google Search Console added platform properties. Connect Instagram, TikTok, X, or YouTube and see the exact search terms sending people to your posts on Search and Discover. Here is what changed and what to do with it."
pubDate: 2026-07-08
category: "seo"
readTime: "6 min"
featured: false
tldr: "On July 7, 2026, Google Search Console added platform properties, a new property type that reports how your Instagram, TikTok, X, and YouTube content performs on Google Search and Discover, even if you don't own a website. You get clicks, impressions, top posts, and the exact queries per post. It rolls out over the coming weeks. The move confirms one thing: your search visibility is no longer one domain, it's your whole footprint. Verify the accounts you use, find the posts already pulling search traffic, and write your captions and titles answer-first, the same way you'd write a page."
recap:
  - "Search Console now has platform properties: connect Instagram, TikTok, X, or YouTube and see the search terms driving people to your posts on Search and Discover, no website required."
  - "You get three reports: Performance (clicks, impressions, per-post queries, export), Insights (trends, top posts, how people find you), and Achievements (milestones). Rolling out over the coming weeks."
  - "The signal is bigger than the feature. Google is confirming it already ranks your off-site content, and your search footprint spans every platform you post on, not just your domain."
tags: ["Google Search Console", "Search Console", "SEO", "Social SEO", "Google Discover"]
faqs:
  - q: "What are platform properties in Google Search Console?"
    a: "Platform properties are a new Search Console property type, launched July 7, 2026, that let you track how your content on Instagram, TikTok, X, and YouTube performs on Google Search and Discover. You connect an account, verify it, and Search Console reports the clicks, impressions, and search queries sending people to your posts. Unlike domain properties, you don't need to own a website to use them."
  - q: "Which platforms does Search Console support?"
    a: "Four at launch: Instagram, TikTok, X, and YouTube. You add each one as a separate property from the Search Console property selector, then follow the onscreen steps to securely authorize the connection. Google says the feature rolls out gradually over the coming weeks, so it may not appear in your account immediately."
  - q: "What data do the platform property reports show?"
    a: "Three reports. Performance shows total clicks, impressions, and additional metrics, filterable by post and query, with an export option. Insights gives a high-level view of recent traffic trends, your top-performing posts, and how people discover your account on Google. Achievements tracks growth milestones like passing a new clicks threshold in the last 28 days."
  - q: "Does this change how I should create social content?"
...
On July 7, Search Console <a href="https://developers.google.com/search/blog/2026/07/search-console-social-video-platforms" rel="nofollow noreferrer" target="_blank">quietly added a new property type</a> called platform properties. Connect one of four accounts, Instagram, TikTok, X, or YouTube, and Google shows you the exact search terms sending people to your posts on Search and Discover. Even if you don't own a website at all.
...
This is the multi-platform visibility shift, on the record. Being findable stopped being one URL a long time ago. It's now your whole footprint: the pages you own, the profiles you post on, and the off-site mentions that decide whether you get [cited by Perplexity](/insights/how-to-get-cited-by-perplexity) and the rest. Google building a dashboard for it is the confirmation, not the cause. The answer, wherever Google assembles it, gets pulled from everywhere you exist, not just your homepage.
...
1. **Verify the accounts you actually use.** No point in tracking a dormant X profile. Connect the one or two platforms where you post real work.
2. **Find your search-winning posts.** Sort Performance by clicks. The posts at the top are your proven formats. That's your next month of content, already validated.
3. **Write posts the way you write pages.** Lead with the answer. Be specific. Match the question people type, not the phrase you wish they typed. A caption or video title that answers a real query gets surfaced. A clever one that answers nothing doesn't. This is [answer engine optimization](/insights/what-is-aeo) applied to a caption box.
4. **Watch Discover.** For social and video, Discover is often the bigger tap than web search. If a post spikes there, that's Google's feed algorithm betting on it. Feed it more.
...
Not sure? Open Google, search your name and your category, and read what comes back in the [Google AI Overview](/insights/google-ai-overviews-optimization) and the results under it. If your name isn't in there, that's the work.

---

**Source:** <a href="https://developers.google.com/search/blog/2026/07/search-console-social-video-platforms" rel="nofollow noreferrer" target="_blank">See how content from social and video platforms performs on Google Search</a>, Google Search Central Blog, July 7, 2026.
